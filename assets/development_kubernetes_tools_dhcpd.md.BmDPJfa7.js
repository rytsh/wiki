...
<span class="line"><span style="color:#FFCB6B;">rc-service</span><span style="color:#C3E88D;"> dhcpd</span><span style="color:#C3E88D;"> start</span></span></code></pre></div><p>When you change the config, you need to restart the service</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme vp-code" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">rc-service</span><span style="color:#C3E88D;"> dhcpd</span><span style="color:#C3E88D;"> restart</span></span></code></pre></div>`,17)]))}const m=a(t,[["render",l]]);export{u as __pageData,m as default};
