import{_ as a,o as n,c as l,ag as e}from"./chunks/framework.BcBuEkoe.js";const C=JSON.parse('{"title":"Cert Manager","description":"Cert manager for Kubernetes cluster certificates management.","frontmatter":{"head":[["meta",{"name":"description","content":"Cert manager for Kubernetes cluster certificates management."}],["meta",{"name":"keywords","content":"kubernetes cert-manager jetstack cert-manager.io"}]]},"headers":[],"relativePath":"development/kubernetes/cluster/certs.md","filePath":"development/kubernetes/cluster/certs.md","lastUpdated":1743799263000}'),p={name:"development/kubernetes/cluster/certs.md"};function o(t,s,c,r,i,y){return n(),l("div",null,s[0]||(s[0]=[e(`<h1 id="cert-manager" tabindex="-1">Cert Manager <a class="header-anchor" href="#cert-manager" aria-label="Permalink to &quot;Cert Manager&quot;">​</a></h1><p>Auto generate certificates for Kubernetes.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme vp-code" tabindex="0"><code><span class="line"><span style="color:#82AAFF;">echo</span><span style="color:#89DDFF;"> &quot;</span><span style="color:#C3E88D;">&gt; Add cert-manager repo</span><span style="color:#89DDFF;">&quot;</span></span>
