import{_ as n,o as a,c as p,ag as l}from"./chunks/framework.BcBuEkoe.js";const E=JSON.parse('{"title":"Proxy Socks5","description":"Kubernetes API to reach with socks5 proxy.","frontmatter":{"head":[["meta",{"name":"description","content":"Kubernetes API to reach with socks5 proxy."}],["meta",{"name":"keywords","content":"socks5 proxy"}]]},"headers":[],"relativePath":"development/kubernetes/cluster/proxy.md","filePath":"development/kubernetes/cluster/proxy.md","lastUpdated":1743799263000}'),o={name:"development/kubernetes/cluster/proxy.md"};function e(t,s,c,r,y,F){return a(),p("div",null,s[0]||(s[0]=[l(`<h1 id="proxy-socks5" tabindex="-1">Proxy Socks5 <a class="header-anchor" href="#proxy-socks5" aria-label="Permalink to &quot;Proxy Socks5&quot;">​</a></h1><p>To reach with socks5 proxy.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme vp-code" tabindex="0"><code><span class="line"><span style="color:#546E7A;font-style:italic;">#!/usr/bin/env bash</span></span>
