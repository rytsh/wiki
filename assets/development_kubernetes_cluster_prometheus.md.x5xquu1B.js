import{_ as a,c as n,a2 as p,o as l}from"./chunks/framework.BQmytedh.js";const D=JSON.parse('{"title":"Prometheus","description":"","frontmatter":{},"headers":[],"relativePath":"development/kubernetes/cluster/prometheus.md","filePath":"development/kubernetes/cluster/prometheus.md","lastUpdated":1737798836000}'),e={name:"development/kubernetes/cluster/prometheus.md"};function o(t,s,c,r,y,i){return l(),n("div",null,s[0]||(s[0]=[p(`<h1 id="prometheus" tabindex="-1">Prometheus <a class="header-anchor" href="#prometheus" aria-label="Permalink to &quot;Prometheus&quot;">​</a></h1><p>Check <a href="https://prometheus-community.github.io/helm-charts" target="_blank" rel="noreferrer">https://prometheus-community.github.io/helm-charts</a> to install the prometheus stack</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme vp-code" tabindex="0"><code><span class="line"><span style="color:#546E7A;font-style:italic;">#!/usr/bin/env bash</span></span>
...
<span class="line"><span style="color:#89DDFF;">EOF</span></span></code></pre></div><h2 id="loki-datasource-to-grafana" tabindex="-1">Loki datasource to Grafana <a class="header-anchor" href="#loki-datasource-to-grafana" aria-label="Permalink to &quot;Loki datasource to Grafana&quot;">​</a></h2><p>Go to sources and add loki datasource with <code>http://loki:3100</code>, just save and skip error.<br> Look predefined dashboards and explore loki.</p>`,5)]))}const E=a(e,[["render",o]]);export{D as __pageData,E as default};
