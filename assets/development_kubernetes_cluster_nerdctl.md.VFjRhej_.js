import{_ as n,o as a,c as l,ag as e}from"./chunks/framework.BcBuEkoe.js";const F=JSON.parse('{"title":"nerdctl","description":"Without using docker in machines but still want to give commands can run as docker, `nerdctl` is a good choice.","frontmatter":{"head":[["meta",{"name":"description","content":"Without using docker in machines but still want to give commands can run as docker, `nerdctl` is a good choice."}],["meta",{"name":"keywords","content":"nerdctl docker containerd"}]]},"headers":[],"relativePath":"development/kubernetes/cluster/nerdctl.md","filePath":"development/kubernetes/cluster/nerdctl.md","lastUpdated":1743799263000}'),o={name:"development/kubernetes/cluster/nerdctl.md"};function p(t,s,c,r,i,d){return a(),l("div",null,s[0]||(s[0]=[e(`<h1 id="nerdctl" tabindex="-1">nerdctl <a class="header-anchor" href="#nerdctl" aria-label="Permalink to &quot;nerdctl&quot;">​</a></h1><p>Without using docker in machines but still want to give commands can run as docker, <code>nerdctl</code> is a good choice.</p><p>Install nerdctl with containerd and enable in systemd.</p><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme vp-code" tabindex="0"><code><span class="line"><span style="color:#546E7A;font-style:italic;">#!/usr/bin/env bash</span></span>
...
<span class="line"><span style="color:#FFCB6B;">nerdctl_permission</span></span></code></pre></div>`,4)]))}const D=n(o,[["render",p]]);export{F as __pageData,D as default};
